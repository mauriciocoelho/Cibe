<form id="add-row-form" action="{{ route('congregacoes.inativar', $register->id) }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title white" id="myModalLabel8">{{ __('Deletar Congregação') }}</h4>
