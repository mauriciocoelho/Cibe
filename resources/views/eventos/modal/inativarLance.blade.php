<form id="add-row-form" action="{{ route('eventos.inativarlance', $register->id) }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title white" id="myModalLabel8">Remover irmã</h4>
                ...
                <div class="modal-body">
                    <p>Você certeza que deseja <b>remover</b> a irmã?</p>
                </div>
