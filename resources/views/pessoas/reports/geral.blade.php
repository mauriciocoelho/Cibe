<html>
    ...
    <body>
        ...
        <div style="border: 0.1mm solid black;padding:0.5em; background-color: rgba(211, 211, 211, 1.0); text-align:center;">
            <strong>LISTAGEM DE IRMÃS</strong>
        </div>
                        ...
                        @if ($gerals->count())
                            <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
                                ...
                                @foreach ($gerals as $geral)
                                    <tbody>   
                                        <tr>
                                            <td class="alt" width="300" >{{$geral->name}}</td>
                                            <td class="alt" width="80" style="text-align:center">{{$geral->celular}}</td>
                                            <td class="alt" width="100" style="text-align:center">{{$geral->congregacao->name}}</td>
                                        </tr>  
                                    </tbody>                                  
                                @endforeach
                                <tr>
